      ...
      <>
        <Row gutter={24}>
          <Col xl={18} lg={24} md={24} sm={24} xs={24} style={{ marginBottom: 24 }}>
            <Card title="实时情况" bordered={false}>
              <Row>
                ...
                {/* <Col md={6} sm={12} xs={24}>
                  <Statistic title="完成率" value="92%" />
                </Col> */}
                {/* <Col md={6} sm={12} xs={24}>
                  <Countdown title="活动剩余时间" value={deadline} format="HH:mm:ss:SSS" />
                </Col> */}
                <Col md={12} sm={12} xs={24}>
                  <Countdown title="任务截止时间" value={deadline} format="HH:mm:ss:SSS" />
                </Col>
              </Row>
          ...
          <Col xl={6} lg={24} md={24} sm={24} xs={24}>
            <Card title="活动时间预测" style={{ marginBottom: 24 }} bordered={false}>
              <ActiveChart />
            </Card>
            <Card
              title="处理效率"
        ...
        <Row gutter={24}>
          <Col xl={12} lg={24} sm={24} xs={24} style={{ marginBottom: 24 }}>
            <Card title="各类点击占比" bordered={false} className={styles.pieCard}>
